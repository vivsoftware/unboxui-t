...
// const Dashboard = ({ userDe, activeTab, buyers, sellers, rfq, tender }) => {
//     const [data1, setdata1] = useState(null);
//     const [options, setoptions] = useState(null);
//     const [user, setUser] = useState(null);
//     const [RfqNo, setRfqNo] = useState(null);
...
//         // Fetch data for RFQs
//         // axios.get(`${spring_boot_url}api/userRfq`)
//         axios.get(`${spring_boot_url}api/rfq`)
//             .then(resp => {
//                 console.log(resp.data.json);
//                 setRfq(resp.data);
//             })
...
//     // }
//     // const allrfq = () => {
//     //     axios.get(`${spring_boot_url}api/adminuser/search?query=rfq`)
//     //         .then(resp => {
//     //             console.log(resp.data.json);
//     //             setRfq(resp.data);
//     //         });
//     // }
//     // const alltender = () => {
//     //     axios.get(`${spring_boot_url}api/adminuser/search?query=tender`)
//     //         .then(resp => {
//     //             console.log(resp.data.json);
//     //             setTender(resp.data);
//     //         });
...
//          // setIsModalOpen(false);
//          console.log("closeBuyerModal clicked");
...
//                                         {(
//                                             <tbody>
//                                                 {Array.isArray(buyers) && buyers.map((elem, index) => (
//                                                     <tr key={index + 1} className='table-row'>
//                                                         <td>{index + 1}</td>
//                                                         <td>{elem.firstName}</td>
//                                                         <td>{elem.id}</td>
