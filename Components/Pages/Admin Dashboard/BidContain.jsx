...
const BidContain = () => {
    ...
    const [isShortlistBid, setShortlistBid] = useState(false);

    const handleBacktoTender = () => {
        setBacktoTender(!backtoTender);
    }
    const openShortlistModal = () => {
        setShortlistBid(true);
    }
    const handleModalClose = () => {
        setShortlistBid(false);
      };
  return (
    <>
                ...
                <div className='container'>
                  ...
                  <p onClick={handleBacktoTender} style={{color:'#FF8400',fontSize:'20px'}}><MdKeyboardBackspace /> Back</p>
                    <div className='col-12'>
                      <input type="search" className="form-control" placeholder="Search Bid ..." aria-label="Search" style={{ height: '40px', border: "1px solid #ddd", borderRadius: '8px' }} />
                    </div>
                  </div>
