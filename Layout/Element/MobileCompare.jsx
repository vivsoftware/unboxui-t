...
const ItemCart = () => {
  ...
  return (
    ...
    >
      ...
      <BiBarChart style={{width:'25px',height:'25px',color:'#FF8400'}} onClick={handleClick}/>
      <span className="label label-theme "style={{position:'relative',top:'-36px',left:'13px',color:'#000'}}>
                {cartData?.length}
              </span>
