...
const MobileCart = (singleProduct) => {
  ...
  return (
    <>
          ...
          <ShoppingCart   style={{ color:  '#FF8400' }}
              onClick={() => handleClick('cart')}/>
          <span className='label label-theme' style={{position:'relative',top:'-40px',left:'30px',color:'#000'}}>{cartData?.length}</span>
